...
module.exports = {
  ...
  obtenerTodaInformacionReservasPorID: 'SELECT res.fecha, res.hora_inicio, res.hora_fin, ins.nombre FROM UCM_AW_RIU_RES_Reservas res  JOIN UCM_AW_RIU_INS_Instalaciones ins ON res.id_instalacion = ins.id WHERE res.id_usuario = ?',
};
